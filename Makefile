...
SOURCES	= attempt_tasks.pl do_select.pl files.pl jobs.pl log.pl \
	  mcfeely-manage mcfeely-queue.c mcfeely.h netstring.c netstring.h \
	  read_results.pl safe_to_exit.pl tasks.pl

OBJECTS = mcfeely-queue.o netstring.o trigger.o fn.o pid.o copy_to_null.o \
...
mcfeely-queue.o: netstring.h trigger.h fn.h copy_to_null.h mcfeely-queue.h \
